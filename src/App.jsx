...
const GLOBAL_FOOD_DATASET = [
  ...
  { name: "Apple (Gala, medium)", calories: 95, protein: 0.5, fat: 0.3, carbs: 25, icon: "🍎" },
  { name: "Apple (Granny Smith, medium)", calories: 95, protein: 0.4, fat: 0.2, carbs: 23, icon: "🍏" },
  { name: "Apple (Honeycrisp, large)", calories: 130, protein: 0.6, fat: 0.4, carbs: 34, icon: "🍎" },
  { name: "Apricot (Raw, 1 fruit)", calories: 17, protein: 0.5, fat: 0.1, carbs: 3.9, icon: "🥣" },
  { name: "Avocado (Hass, small)", calories: 160, protein: 2, fat: 14.7, carbs: 8.5, icon: "🥑" },
  { name: "Avocado (Hass, large)", calories: 322, protein: 4, fat: 29.5, carbs: 17, icon: "🥑" },
  { name: "Banana (Medium)", calories: 105, protein: 1.3, fat: 0.4, carbs: 27, icon: "🍌" },
  { name: "Blackberries (Raw, 1 cup)", calories: 62, protein: 2, fat: 0.7, carbs: 13.8, icon: "🥣" },
  { name: "Blueberries (Raw, 1 cup)", calories: 84, protein: 1.1, fat: 0.5, carbs: 21, icon: "🫐" },
  { name: "Cantaloupe (1 cup pieces)", calories: 54, protein: 1.3, fat: 0.3, carbs: 13, icon: "🍈" },
  { name: "Cherries (Sweet, 1 cup)", calories: 97, protein: 1.6, fat: 0.3, carbs: 25, icon: "🍒" },
  { name: "Clementine (1 fruit)", calories: 35, protein: 0.6, fat: 0.1, carbs: 9, icon: "🍊" },
  { name: "Dates (Deglet Noor, 1 fruit)", calories: 20, protein: 0.2, fat: 0, carbs: 5.3, icon: "🥣" },
  { name: "Dragonfruit (Raw, 1 fruit)", calories: 136, protein: 3, fat: 0, carbs: 29, icon: "🥣" },
  { name: "Fig (Fresh, 1 fruit)", calories: 37, protein: 0.4, fat: 0.2, carbs: 9.6, icon: "🥣" },
  { name: "Grapefruit (Pink, half)", calories: 52, protein: 0.9, fat: 0.2, carbs: 13, icon: "🥣" },
  { name: "Grapes (Red/Green, 1 cup)", calories: 104, protein: 1.1, fat: 0.2, carbs: 27, icon: "🍇" },
  { name: "Guava (1 fruit)", calories: 37, protein: 1.4, fat: 0.5, carbs: 7.9, icon: "🥣" },
  { name: "Honeydew Melon (1 cup pieces)", calories: 61, protein: 0.9, fat: 0.2, carbs: 15.5, icon: "🍈" },
  { name: "Kiwi (Green, 1 fruit)", calories: 42, protein: 0.8, fat: 0.4, carbs: 10, icon: "🥝" },
  { name: "Lemon (1 fruit)", calories: 17, protein: 0.6, fat: 0.2, carbs: 5.4, icon: "🍋" },
  { name: "Mango (1 fruit)", calories: 202, protein: 2.8, fat: 1.3, carbs: 50, icon: "🥭" },
  { name: "Nectarine (1 fruit)", calories: 62, protein: 1.5, fat: 0.5, carbs: 15, icon: "🍑" },
  { name: "Orange (Navel, 1 fruit)", calories: 69, protein: 1.3, fat: 0.2, carbs: 17.5, icon: "🍊" },
  { name: "Papaya (Small, 1 fruit)", calories: 120, protein: 1.3, fat: 0.7, carbs: 30, icon: "🥣" },
  { name: "Peach (Yellow, 1 fruit)", calories: 59, protein: 1.4, fat: 0.4, carbs: 15, icon: "🍑" },
  { name: "Pear (Bartlett, 1 fruit)", calories: 101, protein: 0.6, fat: 0.3, carbs: 27, icon: "🍐" },
  { name: "Pineapple (Raw, 1 cup pieces)", calories: 82, protein: 0.9, fat: 0.2, carbs: 21.6, icon: "🍍" },
  { name: "Plum (1 fruit)", calories: 30, protein: 0.5, fat: 0.2, carbs: 7.5, icon: "🥣" },
  { name: "Pomegranate (1/2 cup arils)", calories: 72, protein: 1.5, fat: 1, carbs: 16, icon: "🥣" },
  { name: "Raspberries (Raw, 1 cup)", calories: 64, protein: 1.5, fat: 0.8, carbs: 15, icon: "🥣" },
  { name: "Strawberries (Raw, 1 cup)", calories: 49, protein: 1, fat: 0.5, carbs: 12, icon: "🍓" },
  { name: "Watermelon (1 cup pieces)", calories: 46, protein: 0.9, fat: 0.2, carbs: 11.5, icon: "🍉" },
  { name: "Asparagus (Raw, 5 spears)", calories: 20, protein: 2.2, fat: 0.1, carbs: 3.7, icon: "🥣" },
  { name: "Bell Pepper (Green, 1 medium)", calories: 24, protein: 1, fat: 0.2, carbs: 5.5, icon: "🫑" },
  { name: "Bell Pepper (Red, 1 medium)", calories: 37, protein: 1.2, fat: 0.4, carbs: 7.2, icon: "🫑" },
  { name: "Broccoli (Raw, 1 cup)", calories: 31, protein: 2.5, fat: 0.3, carbs: 6, icon: "🥦" },
  { name: "Brussels Sprouts (Raw, 1 cup)", calories: 38, protein: 3, fat: 0.3, carbs: 8, icon: "🥣" },
  { name: "Cabbage (Green, raw, 1 cup)", calories: 22, protein: 1.1, fat: 0.1, carbs: 5.2, icon: "🥣" },
  { name: "Carrot (1 medium)", calories: 25, protein: 0.6, fat: 0.1, carbs: 6, icon: "🥕" },
  { name: "Carrots (Baby, 5 medium)", calories: 20, protein: 0.4, fat: 0.1, carbs: 4.8, icon: "🥕" },
  { name: "Cauliflower (Raw, 1 cup)", calories: 25, protein: 2, fat: 0.1, carbs: 5, icon: "🥣" },
  { name: "Celery (Raw, 2 stalks)", calories: 15, protein: 0.7, fat: 0.2, carbs: 3, icon: "🥣" },
  { name: "Corn (Sweet yellow, 1 ear)", calories: 88, protein: 3.3, fat: 1.4, carbs: 19, icon: "🌽" },
  { name: "Cucumber (With peel, 1/2 cucumber)", calories: 23, protein: 1, fat: 0.2, carbs: 5.5, icon: "🥒" },
  { name: "Eggplant (Raw, 1 cup cubes)", calories: 20, protein: 0.8, fat: 0.1, carbs: 4.8, icon: "🍆" },
  { name: "Garlic (1 clove)", calories: 4, protein: 0.2, fat: 0, carbs: 1, icon: "🧄" },
  { name: "Green Beans (Raw, 1 cup)", calories: 31, protein: 1.8, fat: 0.2, carbs: 7, icon: "🥣" },
  { name: "Kale (Raw, 1 cup chopped)", calories: 33, protein: 2.2, fat: 0.6, carbs: 6.7, icon: "🥬" },
  { name: "Lettuce (Iceberg, 1 cup)", calories: 8, protein: 0.5, fat: 0.1, carbs: 1.7, icon: "🥬" },
  { name: "Lettuce (Romaine, 1 cup)", calories: 8, protein: 0.6, fat: 0.1, carbs: 1.5, icon: "🥬" },
  { name: "Mushrooms (White button, 1 cup)", calories: 21, protein: 3, fat: 0.3, carbs: 3, icon: "🍄" },
  { name: "Onion (Yellow, 1 medium)", calories: 44, protein: 1.2, fat: 0.1, carbs: 10, icon: "🧅" },
  { name: "Onion (Red, 1 medium)", calories: 44, protein: 1.2, fat: 0.1, carbs: 10, icon: "🧅" },
  { name: "Peas (Green, 1 cup)", calories: 117, protein: 7.9, fat: 0.6, carbs: 21, icon: "🫛" },
  { name: "Potato (Russet, 1 medium)", calories: 168, protein: 4.6, fat: 0.2, carbs: 38, icon: "🥔" },
  { name: "Potato (Red, 1 medium)", calories: 149, protein: 3.1, fat: 0.2, carbs: 34, icon: "🥔" },
  { name: "Radish (Raw, 5 medium)", calories: 4, protein: 0.2, fat: 0, carbs: 0.8, icon: "🥣" },
  { name: "Spinach (Raw, 1 cup)", calories: 7, protein: 0.9, fat: 0.1, carbs: 1.1, icon: "🥬" },
  { name: "Squash (Butternut, 1 cup cubes)", calories: 63, protein: 1.4, fat: 0.1, carbs: 16, icon: "🥣" },
  { name: "Squash (Zucchini, 1 medium)", calories: 33, protein: 2.4, fat: 0.6, carbs: 6, icon: "🥣" },
  { name: "Sweet Potato (1 medium with skin)", calories: 112, protein: 2, fat: 0.1, carbs: 26, icon: "🥣" },
  { name: "Tomato (Roma, 1 fruit)", calories: 11, protein: 0.5, fat: 0.1, carbs: 2.4, icon: "🍅" },
  { name: "Tomato (Cherry, 1 cup)", calories: 27, protein: 1.3, fat: 0.3, carbs: 5.8, icon: "🍅" },
  { name: "Beef (Ground, 93/7, 3oz)", calories: 152, protein: 22, fat: 7, carbs: 0, icon: "🥩" },
  { name: "Beef (Ribeye Steak, 3oz)", calories: 250, protein: 20, fat: 19, carbs: 0, icon: "🥩" },
  { name: "Beef (Sirloin Steak, 3oz)", calories: 180, protein: 25, fat: 8, carbs: 0, icon: "🥩" },
  { name: "Chicken Breast (Roasted, 3oz)", calories: 140, protein: 26, fat: 3, carbs: 0, icon: "🍗" },
  { name: "Chicken Thigh (Skinless, 3oz)", calories: 170, protein: 22, fat: 9, carbs: 0, icon: "🍗" },
  { name: "Chicken Wing (1 wing, meat only)", calories: 43, protein: 5, fat: 2.5, carbs: 0, icon: "🍗" },
  { name: "Turkey Breast (Roasted, 3oz)", calories: 125, protein: 26, fat: 1.8, carbs: 0, icon: "🥣" },
  { name: "Turkey (Ground, 93/7, 3oz)", calories: 150, protein: 22, fat: 7, carbs: 0, icon: "🥣" },
  { name: "Pork Chop (Center Cut, 3oz)", calories: 175, protein: 24, fat: 8, carbs: 0, icon: "🥣" },
  { name: "Bacon (Pork, 2 slices cooked)", calories: 90, protein: 6, fat: 7, carbs: 0.2, icon: "🥓" },
  { name: "Bacon (Turkey, 2 slices cooked)", calories: 60, protein: 4, fat: 5, carbs: 0.5, icon: "🥓" },
  { name: "Lamb Chop (3oz)", calories: 250, protein: 21, fat: 18, carbs: 0, icon: "🥣" },
  { name: "Salmon (Atlantic, 3oz)", calories: 175, protein: 19, fat: 10, carbs: 0, icon: "🐟" },
  { name: "Tuna (Canned in water, 1 can)", calories: 145, protein: 33, fat: 1, carbs: 0, icon: "🐟" },
  { name: "Shrimp (Cooked, 10 large)", calories: 70, protein: 15, fat: 1, carbs: 0, icon: "🍤" },
  { name: "Egg (Large, 1 whole)", calories: 72, protein: 6, fat: 5, carbs: 0.4, icon: "🍳" },
  { name: "Egg Whites (1/4 cup)", calories: 32, protein: 7, fat: 0, carbs: 0.5, icon: "🥚" },
  { name: "Milk (Whole, 1 cup)", calories: 149, protein: 8, fat: 8, carbs: 12, icon: "🥛" },
  { name: "Milk (2% Reduced Fat, 1 cup)", calories: 122, protein: 8, fat: 5, carbs: 12, icon: "🥛" },
  { name: "Milk (Skim, 1 cup)", calories: 83, protein: 8, fat: 0.2, carbs: 12, icon: "🥛" },
  { name: "Greek Yogurt (Non-fat, 5.3oz)", calories: 80, protein: 15, fat: 0, carbs: 6, icon: "🥣" },
  { name: "Greek Yogurt (Whole Milk, 5.3oz)", calories: 140, protein: 12, fat: 7, carbs: 6, icon: "🥣" },
  { name: "Cottage Cheese (2% Fat, 1/2 cup)", calories: 90, protein: 12, fat: 2.5, carbs: 4.5, icon: "🥣" },
  { name: "Cheddar Cheese (1oz)", calories: 115, protein: 7, fat: 9, carbs: 0.4, icon: "🧀" },
  { name: "Mozzarella (Part-skim, 1oz)", calories: 72, protein: 7, fat: 4.5, carbs: 0.8, icon: "🧀" },
  { name: "Parmesan (Grated, 1 tbsp)", calories: 22, protein: 1.9, fat: 1.4, carbs: 0.2, icon: "🧀" },
  { name: "Butter (Salted, 1 tbsp)", calories: 102, protein: 0.1, fat: 11.5, carbs: 0, icon: "🧈" },
  { name: "Heavy Cream (1 tbsp)", calories: 51, protein: 0.4, fat: 5.4, carbs: 0.4, icon: "🥛" },
  { name: "Sour Cream (1 tbsp)", calories: 23, protein: 0.3, fat: 2.3, carbs: 0.4, icon: "🥣" },
  { name: "Whey Protein Isolate (1 scoop)", calories: 120, protein: 25, fat: 0.5, carbs: 2, icon: "🥣" },
  { name: "Scallops (Cooked, 3oz)", calories: 94, protein: 17, fat: 0.7, carbs: 4, icon: "🥣" },
  { name: "Bread (White, 1 slice)", calories: 75, protein: 2.5, fat: 1, carbs: 14, icon: "🍞" },
  { name: "Bread (Whole Wheat, 1 slice)", calories: 81, protein: 3.9, fat: 1.1, carbs: 13.7, icon: "🍞" },
  { name: "Bread (Sourdough, 1 slice)", calories: 100, protein: 4, fat: 0.5, carbs: 20, icon: "🍞" },
  { name: "Bagel (Plain, 1 medium)", calories: 250, protein: 10, fat: 1.5, carbs: 48, icon: "🥯" },
  { name: "Rice (White, cooked, 1 cup)", calories: 205, protein: 4.3, fat: 0.4, carbs: 45, icon: "🍚" },
  { name: "Rice (Brown, cooked, 1 cup)", calories: 216, protein: 5, fat: 1.8, carbs: 45, icon: "🍚" },
  { name: "Quinoa (Cooked, 1 cup)", calories: 222, protein: 8.1, fat: 3.6, carbs: 39, icon: "🥣" },
  { name: "Oats (Old Fashioned, 1/2 cup dry)", calories: 150, protein: 5, fat: 3, carbs: 27, icon: "🥣" },
  { name: "Pasta (Spaghetti, cooked, 1 cup)", calories: 221, protein: 8.1, fat: 1.3, carbs: 43, icon: "🍝" },
  { name: "Popcorn (Air-popped, 3 cups)", calories: 93, protein: 3, fat: 1.1, carbs: 19, icon: "🍿" },
  { name: "Lentils (Cooked, 1 cup)", calories: 230, protein: 18, fat: 0.8, carbs: 40, icon: "🥣" },
  { name: "Chickpeas (Canned, 1/2 cup)", calories: 134, protein: 7, fat: 2.1, carbs: 22, icon: "🥣" },
  { name: "Black Beans (Canned, 1/2 cup)", calories: 114, protein: 7.6, fat: 0.5, carbs: 20, icon: "🥣" },
  { name: "Kidney Beans (Canned, 1/2 cup)", calories: 108, protein: 8, fat: 0.4, carbs: 19, icon: "🥣" },
  { name: "Edamame (Shelled, 1/2 cup)", calories: 94, protein: 9, fat: 4, carbs: 7, icon: "🫛" },
  { name: "Almonds (Raw, 1oz/28g)", calories: 164, protein: 6, fat: 14, carbs: 6, icon: "🥣" },
  { name: "Walnuts (Halves, 1oz/28g)", calories: 185, protein: 4.3, fat: 18.5, carbs: 3.9, icon: "🥣" },
  { name: "Cashews (Raw, 1oz/28g)", calories: 157, protein: 5.2, fat: 12.4, carbs: 8.6, icon: "🥣" },
  { name: "Pistachios (Shelled, 1oz/28g)", calories: 159, protein: 5.7, fat: 12.8, carbs: 7.7, icon: "🥣" },
  { name: "Peanuts (Dry roasted, 1oz/28g)", calories: 166, protein: 6.9, fat: 14.1, carbs: 6.1, icon: "🥜" },
  { name: "Chia Seeds (1 tbsp)", calories: 58, protein: 2, fat: 4, carbs: 5, icon: "🥣" },
  { name: "Flax Seeds (Ground, 1 tbsp)", calories: 37, protein: 1.3, fat: 3, carbs: 2, icon: "🥣" },
  { name: "Pumpkin Seeds (1oz/28g)", calories: 163, protein: 8.5, fat: 13.9, carbs: 4.2, icon: "🥣" },
  { name: "Sunflower Seeds (1oz/28g)", calories: 165, protein: 5.5, fat: 14, carbs: 6.8, icon: "🥣" },
  { name: "Olive Oil (1 tbsp)", calories: 119, protein: 0, fat: 13.5, carbs: 0, icon: "🫒" },
  { name: "Coconut Oil (1 tbsp)", calories: 121, protein: 0, fat: 13.5, carbs: 0, icon: "🥣" },
  { name: "Honey (1 tbsp)", calories: 64, protein: 0.1, fat: 0, carbs: 17, icon: "🍯" },
  { name: "Sugar (White, 1 tbsp)", calories: 49, protein: 0, fat: 0, carbs: 12.6, icon: "🥣" },
  { name: "Hummus (Traditional, 2 tbsp)", calories: 70, protein: 2, fat: 5, carbs: 4, icon: "🥣" },
  { name: "Tortilla (Flour, 8-inch)", calories: 144, protein: 4, fat: 3.7, carbs: 24, icon: "🥣" },
  { name: "Tortilla (Corn, 6-inch)", calories: 52, protein: 1.4, fat: 0.7, carbs: 10.7, icon: "🥣" },
  { name: "Tofu (Firm, 3oz)", calories: 71, protein: 8, fat: 3.5, carbs: 2, icon: "🥣" }
];
